 ...
 * Generated at: 2023-10-20 09:34:09 UTC
...
public final class home_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			<form action=\"/member/insertMember.do\" method=\"post\" name=\"insertMember\" id=\"insertMember\" enctype=\"multipart/form-data\">\n");
      out.write("				<div class=\"row\" style=\"padding: 5px 0px 5px\">\n");
      out.write("						<input type=\"file\" name=\"upfile\" class=\"form-control\" id=\"inputGroupFile02\">\n");
      ...
      out.write("			\n");
      out.write("			// 4. 닉네임\n");
      out.write("			if($(\"input[name='m_nickname']\").val().length < 2) {\n");
      ...
      out.write("			\n");
      out.write("			// 5. 이름\n");
      out.write("			if($(\"input[name='m_name']\").val().length < 2) {\n");
      ...
      out.write("			\n");
      out.write("			// 6. 주소\n");
      out.write("			if($(\"input[name='m_address']\").val().length < 1) {\n");
      ...
      out.write("						return;\n");
      out.write("					}\n");
      out.write("					console.log($(\"#m_phone4\").val() + $(\"#m_phone2\").val() + $(\"#m_phone3\").val());\n");
      out.write("				} else {\n");
      out.write("					console.log($(\"#m_phone1\").val() + $(\"#m_phone2\").val() + $(\"#m_phone3\").val());\n");
      out.write("				}\n");
      out.write("			} \n");
      out.write(" 			*/\n");
      out.write("\n");
      ...
      out.write("			\n");
      out.write("			$(\"#inputGroupFile02\").files = input.files[0];\n");
      out.write("		} else {\n");
