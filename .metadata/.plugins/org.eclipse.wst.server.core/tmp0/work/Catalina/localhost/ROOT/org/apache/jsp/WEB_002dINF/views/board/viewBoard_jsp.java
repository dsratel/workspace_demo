 ...
 * Generated at: 2023-11-16 04:55:29 UTC
...
public final class viewBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("													+			data[i].seq + \", \" + data[i].rootseq + \", \" + data[i].depth + \", \" + data[i].re_order + \", this)'>답글</button><br/>\";\r\n");
      out.write("							\r\n");
      out.write("													if(\"");
      ...
      out.write("		\r\n");
      out.write("		// 댓글 - 답글\r\n");
      out.write("		function replyCmtForm(cmtSeq, rootSeq, depth, re_order, el) {\r\n");
      ...
      out.write("						+					cmtSeq + \", \" + rootSeq + \", \" + depth + \", \" + re_order + \")'>대댓글</button>\"\r\n");
      ...
      out.write("		\r\n");
      out.write("		// 댓글 - 답글 요청\r\n");
      out.write("		function replyCmtProc(pid, rootSeq, depth, re_order) {\r\n");
      out.write("			// cmtForm 초기화\r\n");
      out.write("			cmtFormReset();\r\n");
      out.write("			\r\n");
      ...
      out.write("			$(\"form[name='cmtForm'] input[name='rootseq']\").val(rootSeq);\r\n");
      out.write("			$(\"form[name='cmtForm'] input[name='pid']\").val(pid);\r\n");
      out.write("			$(\"form[name='cmtForm'] input[name='depth']\").val(depth+1);\r\n");
      out.write("			$(\"form[name='cmtForm'] input[name='re_order']\").val(re_order+1);\r\n");
      out.write("			\r\n");
      out.write("			\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				type: \"post\",\r\n");
    ...
    try {
      ...
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write(',');
          out.write(' ');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cmt.re_order}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/viewBoard.jsp(134,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
