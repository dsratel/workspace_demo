 ...
 * Generated at: 2023-11-13 07:05:24 UTC
...
public final class viewBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("		<div>\r\n");
      out.write("			<input type=\"text\" id=\"test\">\r\n");
      out.write("		</div>\r\n");
      ...
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			// 댓글 시간 포맷 변경\r\n");
      out.write("/* 			var cmtTimes = $(\".cmtTime span\");\r\n");
      out.write("			for(var i=0; i < cmtTimes.length; i++) {\r\n");
      out.write("				cmtTimes.get(i).remove();\r\n");
      out.write("				console.log(cvtDateFormat(new Date(parseInt(cmtTimes.get(i).innerText))));\r\n");
      out.write("				$(\".cmtTime\").get(i).append(\"<span>\" + cvtDateFormat(new Date(parseInt(cmtTimes.get(i).innerText))) + \"</span>\");\r\n");
      out.write("				\r\n");
      out.write("				\r\n");
      out.write("			} */\r\n");
      out.write("			\r\n");
      ...
      out.write("				if($(\"input[name='pw']\").val().length < 4) {\r\n");
      ...
      out.write("					data: $(\"form[name='cmtForm']\").serialize(),\r\n");
      ...
      out.write("		function commentReload(boardSeq) {\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				type: \"post\",\r\n");
      out.write("				url: \"/comment/list\",\r\n");
      out.write("				data: {\r\n");
      out.write("					\"boardseq\" : boardSeq	\r\n");
      out.write("				},\r\n");
      out.write("				success: function(data) {\r\n");
      ...
      out.write("\" == data[i].id) {\r\n");
      out.write("													appendStr =	appendStr + \"<div class='col-2'>\"\r\n");
      out.write("															+		\"<button type='button' class='btn btn-danger' \"\r\n");
      out.write("															+ 		\"onclick='delCmt(\" + data[i].seq +\", \" + data[i].boardseq +\")'>삭제</button>\"\r\n");
      out.write("															+	\"</div>\";\r\n");
      out.write("												}\r\n");
      out.write("						appendStr = appendStr + \"</div> </div>\";\r\n");
      out.write("					}\r\n");
      out.write("					\r\n");
      ...
      out.write("		\r\n");
      out.write("		// 댓글 삭제\r\n");
      out.write("		function delCmt(cmtSeq, boardSeq) {\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				type: \"get\",\r\n");
      out.write("				url: \"/comment/delete.do\",\r\n");
      out.write("				data: {\"seq\" : cmtSeq},\r\n");
      out.write("				success: function(data){\r\n");
      out.write("					commentReload(boardSeq);\r\n");
      out.write("				},\r\n");
      out.write("				error: function(data){\r\n");
      out.write("					console.log(data);\r\n");
      ...
      out.write("		function delPwCheck (cmtSeq, cmtPw, boardSeq) {\r\n");
      out.write("			window.open(\"/comment/toPwCheck\", \"댓글 비밀번호 입력\", \"width=700px,height=800px,scrollbars=yes\");\r\n");
      out.write("			//window.location.href = \"/comment/toPwCheck\";\r\n");
      out.write("			/*\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				type: \"post\",\r\n");
      out.write("				url: \"/comment/passwordCheck\",\r\n");
      out.write("				data: {\"seq\" : cmtSeq, \"pw\" : cmtPw},\r\n");
      out.write("				success: function(data){\r\n");
      out.write("					if(data > 0 && confirm(\"정말 댓글을 삭제하시겠습니까?\")) {\r\n");
      out.write("						delCmt(cmtSeq, boardSeq);					\r\n");
      out.write("					}\r\n");
      out.write("				},\r\n");
      out.write("				error: function(data) {\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(61,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("filePath");
      // /WEB-INF/views/comment/viewBoard.jsp(61,4) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/comment/viewBoard.jsp(61,4) '${files }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${files }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(70,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fotherwise_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(78,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("cmt");
      // /WEB-INF/views/comment/viewBoard.jsp(78,6) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/comment/viewBoard.jsp(78,6) '${cmtList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${cmtList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(90,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(90,16) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(91,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(91,16) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(93,9) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${loginId == cmt.id}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      int _jspx_eval_c_005fif_005f0 = _jspx_th_c_005fif_005f0.doStartTag();
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("										<div class=\"col-2\">\r\n");
          out.write("											<button type=\"button\" class=\"btn btn-danger\" onclick=\"delPwCheck(");
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(106,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("						<input type=\"password\" name=\"pw\" placeholder=\"password\" maxlength=\"20\">\r\n");
          out.write("						<input type=\"hidden\" name=\"boardseq\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.seq}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\">	<br/>\r\n");
          out.write("						<textarea name=\"content\" id=\"cmtContent\"></textarea>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/comment/viewBoard.jsp(126,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${loginId == dto.author}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
