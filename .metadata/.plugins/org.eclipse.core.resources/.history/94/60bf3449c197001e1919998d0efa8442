...
<body id="page-top">
							...
							<c:if test="${loginId ne ''}">
								...
								<div class="col-3" style="position:relative;">
									<c:if test="${masteryn eq 'y'.charAt(0)}">
										<button type="button" class="btn btn-info" id="masterMenu" style="position:absolute;top:50%;transform:translate(-130%, -50%);">관리자 메뉴</button>
										<button type="button" class="btn btn-danger" id="selDelBtn" style="position:absolute;top:50%;transform:translate(-10%, -50%);">선택한 게시글 삭제</button>
									</c:if>
									<button type="button" class="btn btn-warning" id="writeBtn" style="position:absolute;top:50%;transform:translate(200%, -50%);">글 작성</button>
								</div>
							</c:if>
						</div>
	...
	<!-- <script src="/resources2/test.js"></script> -->
	<script>
	$(function() {
		// 글 작성 버튼
